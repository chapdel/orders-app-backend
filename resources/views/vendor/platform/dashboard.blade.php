...
<div class="aside col-xs-12 col-md-2 col-xl-2 col-xxl-3 bg-dark">
    <div class="d-md-flex align-items-start flex-column d-sm-block h-full">
        ...
        <div class="d-sm-flex d-md-block p-3 mt-md-4 w-100 v-center">
            <a href="#" class="header-toggler d-md-none mr-auto order-first" data-toggle="collapse" data-target="#headerMenuCollapse">
        ...
        <div class="h-100 w-100 position-relative to-top cursor d-none d-md-block mt-md-5 divider" data-action="click->layouts--html-load#goToTop" title="{{ __('Go to top') }}">
